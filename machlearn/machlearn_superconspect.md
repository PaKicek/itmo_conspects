...
* [Машинное обучение](#%D0%BC%D0%B0%D1%88%D0%B8%D0%BD%D0%BD%D0%BE%D0%B5-%D0%BE%D0%B1%D1%83%D1%87%D0%B5%D0%BD%D0%B8%D0%B5)
  ...
  * [Лекция 14. Свёрточные и рекуррентные нейросети](#%D0%BB%D0%B5%D0%BA%D1%86%D0%B8%D1%8F-14.-%D1%81%D0%B2%D1%91%D1%80%D1%82%D0%BE%D1%87%D0%BD%D1%8B%D0%B5-%D0%B8-%D1%80%D0%B5%D0%BA%D1%83%D1%80%D1%80%D0%B5%D0%BD%D1%82%D0%BD%D1%8B%D0%B5-%D0%BD%D0%B5%D0%B9%D1%80%D0%BE%D1%81%D0%B5%D1%82%D0%B8)
    ...
    * [LSTM](#lstm)
  * [Лекция 15. Большие языковые модели](#%D0%BB%D0%B5%D0%BA%D1%86%D0%B8%D1%8F-15.-%D0%B1%D0%BE%D0%BB%D1%8C%D1%88%D0%B8%D0%B5-%D1%8F%D0%B7%D1%8B%D0%BA%D0%BE%D0%B2%D1%8B%D0%B5-%D0%BC%D0%BE%D0%B4%D0%B5%D0%BB%D0%B8)
    * [Трансформер](#%D1%82%D1%80%D0%B0%D0%BD%D1%81%D1%84%D0%BE%D1%80%D0%BC%D0%B5%D1%80)
    * [Генерация, дополненная поиском](#%D0%B3%D0%B5%D0%BD%D0%B5%D1%80%D0%B0%D1%86%D0%B8%D1%8F%2C-%D0%B4%D0%BE%D0%BF%D0%BE%D0%BB%D0%BD%D0%B5%D0%BD%D0%BD%D0%B0%D1%8F-%D0%BF%D0%BE%D0%B8%D1%81%D0%BA%D0%BE%D0%BC)

<!-- begin machlearn_2025_09_05.md -->
...
* Равномерное распределение $U(a, b)$ - непрерывное распределение, случайная величина $\xi$ которого имеет функцию плотности $$f_\xi(x) = \begin{cases}0, & x < a \\ \frac{1}{b - a}, & a \leq x \leq b \\ 0, & x > b\end{cases}$$
...
* Дисперсия $D \xi$ - математическое ожидание квадрата отклонения случайной величины от ее математического ожидания. В общем случае $D\xi = E(\xi - E\xi)^2 = E\xi^2 - (E\xi)^2$
    ...
    Для дискретного распределения $\displaystyle D \xi = \sum_{i = 1}^n p_i (x_i - E\xi)^2$

    Для непрерывного распределения $\displaystyle D \xi = \int_{-\infty}^\infty f_\xi(x) (x - E\xi)^2 dx$
...
<!-- end machlearn_2025_09_05.md -->

<!-- begin machlearn_2025_09_12.md -->
---
...
2. Стандартизация
    ...
    [Стандартизация](https://en.wikipedia.org/wiki/Feature_scaling#Standardization_(Z-score_Normalization)) (или Z-масштабирование) преобразует выборку так, что бы среднее было равно 0, а дисперсия - 1:
...
$P(X \leq -K) + P(X \geq K) = 1 - P(-K \geq X \geq K) = 1 - (\Phi(K) - \Phi(-K)) = 1 - 2 \Phi(K)$
...
<!-- end machlearn_2025_09_12.md -->

<!-- begin machlearn_2025_09_19.md -->
...
<!-- end machlearn_2025_09_19.md -->

<!-- begin machlearn_2025_09_26.md -->
...
<!-- end machlearn_2025_09_26.md -->

<!-- begin machlearn_2025_10_03.md -->
...
* **Запоминанием** или полнотой (Recall) модели называют долю истинно положительных от всех действительно положительных результатов: $\displaystyle \mathrm{Recall} = \frac{\mathrm{TP}}{\mathrm{TP} + \mathrm{FN}}$
...
<!-- end machlearn_2025_10_03.md -->

<!-- begin machlearn_2025_10_10.md -->
...
* Эластичная сеть (Elastic net regularization) является комбинацией предыдущий двух регуляризаций:
    ...
    Почти всегда устойчив к коррелированным признакам, подходит для разреженных данных. Эластичную сеть следует использовать, когда количество признаков больше количества объектов
...
<!-- end machlearn_2025_10_10.md -->

<!-- begin machlearn_2025_10_17.md -->
...
<!-- end machlearn_2025_10_17.md -->

<!-- begin machlearn_2025_10_24.md -->
...
<!-- end machlearn_2025_10_24.md -->

<!-- begin machlearn_2025_10_31.md -->
...
<!-- end machlearn_2025_10_31.md -->

<!-- begin machlearn_2025_11_07.md -->
...
<!-- end machlearn_2025_11_07.md -->

<!-- begin machlearn_2025_11_17.md -->
...
* Для регрессии используют среднее значение абсолютных разностей (MAE) $$\mathcal{L}_\mathrm{MAE} (y, \hat y) = \frac{1}{n} \sum_{i = 1}^n \vert y_i - \hat y_i \vert $$ или среднее значение квадратов разностей (MSE) $$\mathcal{L}_\mathrm{MSE} (y, \hat y) = \frac{1}{n} \sum_{i = 1}^n (y_i - \hat y_i)^2$$
    ...
    Или лог-кошинус (log-cosh):

    $$\mathcal{L} = \log (\mathrm{cosh}(y - \hat y))$$

    Лог-кошинус аппроксимирует функцию Хубера, но не требует выбора $\delta$. Также она гладкая, что упрощает оптимизацию градиента
...
<!-- end machlearn_2025_11_17.md -->

<!-- begin machlearn_2025_11_21.md -->
...
<!-- end machlearn_2025_11_21.md -->

<!-- begin machlearn_2025_12_05.md -->
...
<!-- end machlearn_2025_12_05.md -->

<!-- begin machlearn_2025_12_12.md -->
...
<!-- end machlearn_2025_12_12.md -->

<!-- begin machlearn_2025_12_19.md -->
## <a name="%D0%BB%D0%B5%D0%BA%D1%86%D0%B8%D1%8F-15.-%D0%B1%D0%BE%D0%BB%D1%8C%D1%88%D0%B8%D0%B5-%D1%8F%D0%B7%D1%8B%D0%BA%D0%BE%D0%B2%D1%8B%D0%B5-%D0%BC%D0%BE%D0%B4%D0%B5%D0%BB%D0%B8"></a> Лекция 15. Большие языковые модели
...
### <a name="%D1%82%D1%80%D0%B0%D0%BD%D1%81%D1%84%D0%BE%D1%80%D0%BC%D0%B5%D1%80"></a> Трансформер
...
### <a name="%D0%B3%D0%B5%D0%BD%D0%B5%D1%80%D0%B0%D1%86%D0%B8%D1%8F%2C-%D0%B4%D0%BE%D0%BF%D0%BE%D0%BB%D0%BD%D0%B5%D0%BD%D0%BD%D0%B0%D1%8F-%D0%BF%D0%BE%D0%B8%D1%81%D0%BA%D0%BE%D0%BC"></a> Генерация, дополненная поиском
